...
def process_log_data(spark, input_data, output_data):
	...
	"""
		Loads log_data from S3, extracting needed columns for users, time and songplays tables
		and writting their parquet format on S3
	...
	log_data = os.path.join(inout_data, 'log_data/*/*/*.json')
...
def main():
	...
	output_data = "s3a://sparkproject-udacity/"
